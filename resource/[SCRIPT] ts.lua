...
local Menu = {
    ...
    Wallhack2 = imgui.new.bool(false),
...
--> cheats
                if imgui.BeginPopupModal('Cheats##pup', _, imgui.WindowFlags.NoResize) then
                    ...
                    if imgui.BeginChild('Cheats', imgui.ImVec2(size.x - 10, size.y - 5 - 30 - 30), true) then
                            imgui.SetCursorPosX(5)
                            if imgui.Button(faicons('eye') .. ' Wallhack', imgui.ImVec2(size.x - 20, 24)) then
                            ...
                            if imgui.Button(faicons('eye') .. ' New', imgui.ImVec2(size.x - 20, 24)) then
                                Menu.Wallhack2[0] = not Menu.Wallhack2[0]
                                imgui.CloseCurrentPopup()
                            end
